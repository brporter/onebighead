...
public static class DatabaseSeeder
{
    public static void SeedDevelopmentData(AppDbContext context)
    {
        ...
        if (!context.Categories.Any())
        {
            ...
            {
                new() { Id = 1, TenantId = 1, Name = "Unassigned Items", Description = "Items without a category", ParentCategoryId = null, IsSystem = true },
                new() { Id = 2, TenantId = 1, Name = "Motorola 68000 Computers", Description = "Some Description", ParentCategoryId = null },
                new() { Id = 3, TenantId = 1, Name = "Compact Macintosh", Description = "Some description", ParentCategoryId = 2 },
                new() { Id = 4, TenantId = 1, Name = "Apple II", Description = "Some description", ParentCategoryId = 2 },
                new() { Id = 5, TenantId = 1, Name = "Peripherals", Description = "Some description", ParentCategoryId = null },
                new() { Id = 6, TenantId = 1, Name = "Monitors", Description = "Some description", ParentCategoryId = 5 },
                new() { Id = 7, TenantId = 1, Name = "Printers", Description = "Some description", ParentCategoryId = 5 },
                new() { Id = 8, TenantId = 1, Name = "Intel Computers", Description = "Some description", ParentCategoryId = null }
            };
