...
namespace OneBigHead.Server.Migrations
{
    ...
    [Migration("20260226041726_AddItemMatching")]
    partial class AddItemMatching
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneBigHead.Server.Models.ItemEmbedding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ItemEmbeddings");
                });

            modelBuilder.Entity("OneBigHead.Server.Models.ItemMatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TradeUserStatus")
                        .HasColumnType("int");

                    b.Property<int>("TradeWorkspaceId")
                        .HasColumnType("int");

                    b.Property<int>("WantItemId")
                        .HasColumnType("int");

                    b.Property<int>("WantUserStatus")
                        .HasColumnType("int");

                    b.Property<int>("WantWorkspaceId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TradeWorkspaceId");

                    b.HasIndex("WantWorkspaceId");

                    b.HasIndex("WantItemId", "TradeItemId")
                        .IsUnique();
            ...
            modelBuilder.Entity("OneBigHead.Server.Models.MatchMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SenderWorkspaceId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ItemMatchId");

                    b.HasIndex("ItemMatchId", "CreatedAt");

                    b.ToTable("MatchMessages");
                });

            modelBuilder.Entity("OneBigHead.Server.Models.MatchQueueEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OneBigHead.Server.Models.MatchMessage", b =>
                {
                    b.HasOne("OneBigHead.Server.Models.ItemMatch", "ItemMatch")
                        .WithMany()
                        .HasForeignKey("ItemMatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ItemMatch");
                });
